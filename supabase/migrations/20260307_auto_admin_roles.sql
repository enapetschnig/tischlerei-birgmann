-- Auto-Admin-Rolle für Petra und Franz Birgmann
-- napetschnig.chris@gmail.com bleibt ebenfalls Administrator
...
BEGIN
  IF NEW.email IN ('napetschnig.chris@gmail.com', 'petra@tischlerei-birgmann.at', 'franz.birgmann@tischlerei-birgmann.at') THEN
...
-- ensure_user_profile ebenfalls aktualisieren
...
BEGIN
  ...
  IF user_email IN ('napetschnig.chris@gmail.com', 'petra@tischlerei-birgmann.at', 'franz.birgmann@tischlerei-birgmann.at') THEN
    assigned_role := 'administrator';
  ELSE
    assigned_role := 'mitarbeiter';
  END IF;
